...
**2. Read mode :** WL=1 ==> Aceess transistors will be on.
...
When Q less than Vth of M1 then M1 gets off. Qb becomes high as PMOS(M2) connected toVdd will be ON and Q becomes low i.e logic’0’
That i.e write operation is done by forcing bitlines bl and br , which is done using write driver circuit.
